...
package io.pivotal.spring.cloud.stream.gemfire.embedded.sink.config;
 ...
 */
@Configuration
@Import(GemfireSinkClientCacheConfiguration.class)
@EnableConfigurationProperties(GemfireSinkRegionProperties.class)
public class GemfireSinkClientRegionConfiguration {

	@Autowired
	private GemfireSinkRegionProperties config;
