 ...
 */
@Configuration
@Import(GemfireSourceClientCacheConfiguration.class)
@EnableConfigurationProperties(GemfireSourceRegionProperties.class)
public class GemfireSourceClientRegionConfiguration {

	@Autowired
	private GemfireSourceRegionProperties config;
