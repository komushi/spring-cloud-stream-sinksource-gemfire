...
package io.pivotal.spring.cloud.stream.gemfire.embedded.sink;

import com.gemstone.gemfire.cache.Region;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.context.properties.EnableConfigurationProperties;
import org.springframework.cloud.stream.annotation.EnableBinding;
import org.springframework.cloud.stream.app.gemfire.sink.config.GemfireSinkClientRegionConfiguration;
...
@Import({ GemfirePoolConfiguration.class, GemfireSinkClientRegionConfiguration.class })
...
public class GemfireSinkConfiguration {
	...
	@Resource(name = "sinkClientRegion")
