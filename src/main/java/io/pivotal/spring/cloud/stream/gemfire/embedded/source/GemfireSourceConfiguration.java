...
package io.pivotal.spring.cloud.stream.gemfire.embedded.source;
...
import io.pivotal.spring.cloud.stream.gemfire.embedded.common.JsonObjectTransformer;
import org.springframework.cloud.stream.app.gemfire.source.config.GemfireSourceClientRegionConfiguration;
import io.pivotal.spring.cloud.stream.gemfire.embedded.common.GemfirePoolConfiguration;
...
@Import({ KeyInterestConfiguration.class,
		...
		GemfireSourceClientRegionConfiguration.class })
...
public class GemfireSourceConfiguration {
	...
	@Resource(name = "sourceClientRegion")
